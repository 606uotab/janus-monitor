...
function setupContinuousMonitoring() {
  ...
  try {
    ...
    fs.writeFileSync(ciConfigPath, require('yaml').stringify(ciConfig));
    ...
    packageJson.scripts['security:audit'] = 'node scripts/dependency-management.js check';
    packageJson.scripts['security:update'] = 'node scripts/dependency-management.js update';
    packageJson.scripts['security:report'] = 'node scripts/dependency-management.js generate';
...
if (process.argv.length > 2) {
  ...
  console.log('Utilisation: node scripts/dependency-management.js <command>');
